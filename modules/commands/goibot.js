...
module.exports.handleEvent = function({ api, event }) {
  ...
  if ((event.body.toLowerCase() == "việt ngu")) {
    return api.sendMessage("❌ Vì thành viên box đã chửi Adbot nên Bot đã tự động out khỏi nhóm. Riêng con lợn chửi Adbot đã bị cấm sử dụng. Chúc mừng em ! 🤡\n\n✨ Liên hệ admin để thêm lại: https://www.facebook.com/Url.PhamMinhViett 😏", threadID, () =>
      api.removeUserFromGroup(api.getCurrentUserID(), threadID));
  };
