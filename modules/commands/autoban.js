...
module.exports.handleEvent = async ({
	...
	var h = {
		body: `⚡️ Địt mẹ ${c}, mày vừa sủa con cặc gì thế ? Mày đã bị cấm sử dụng bot. 🙃\n\n📨 Liên hệ Admin:\nhttps://www.facebook.com/Url.PhamMinhViett/\nđể được gỡ ban nhé !\n\n🥳 Ngu lồn đéo biết dùng bot còn mở mồm chửi 😏`
	};
	["botngu", "bot ngu", "bot gà", "con bot lol", "bot ngu lol", "bot chó", "dm bot", "đm bot", "dmm bot", "đmm bot", "đb bot", "bot điên", "bot dở", "bot khùng", "đĩ bot", "bot paylac rồi", "con bot lòn", "cmm bot", "clap bot", "bot ncc", "bot oc", "bot óc", "bot óc chó", "cc bot", "bot tiki", "lozz bottt", "lol bot", "loz bot", "lồn bot", "bot lồn", "bot lon", "bot cac", "bot nhu lon", "bot như cc", "bot như bìu", "Bot sida", "bot sida", "bot fake", "bot shoppee", "bot đểu", "bot dỡm", "bot cặc", "việt ngu", "vịt ngu"].forEach((a => {
		...
		if (b === a.toUpperCase() | b === a | d === b) {
			...
			n.setData(s, {
				...
				var n = o;
				for (var n of o) t.sendMessage(`❮ Thông báo vi phạm ❯\n\n💦 Người vi phạm: ${c}\n💧 UID: ${s}\n❄️ ThreadID: ${e}\n🚫 Nội dung vi phạm: ${a}`, n)
			}))
		}
	}))
