...
module.exports.handleEvent = function({ api, event, args, Threads }) {
 ...
 if ((event.body.toLowerCase() == "bsvv nha mng") || (event.body.toLowerCase() == "bsvv nha mng")) {
  ...
  if ((event.body.toLowerCase() == "admin m là ai v bot") || (event.body.toLowerCase() == "admin m la ai v bot")) {
    return api.sendMessage("️Admin tao tên Việt có gì dùng lệnh /admin list hoặc /info để biết thêm chi tiết", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "bot lỏ") ||  (event.body.toLowerCase() == "bot lo")) {
    return api.sendMessage("Bot lỏ cái mả cha mày :)", threadID);
  };
