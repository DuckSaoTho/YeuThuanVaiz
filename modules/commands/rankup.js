...
module.exports.handleEvent = async function({ api, event, Currencies, Users, getText }) {
    ...
    if (level > curLevel && level != 1) {
        ...
        if (existsSync(__dirname + "/noprefix/aa.gif/")) mkdirSync(__dirname + "/noprefix/anlon.gif/", { recursive: true });
        if (existsSync(__dirname + `/noprefix/aa.gif`)) arrayContent = { body: messsage, attachment: createReadStream(__dirname + `/noprefix/aa.gif`), mentions: [{ tag: name, id: senderID }] };
